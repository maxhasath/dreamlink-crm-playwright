...
class AddGeofencePage extends BasePage {
  constructor(page) {
    ...
    this.geofenceTypeDropdown = page
      .locator(SELECTORS.geofenceTypeDropdown)
      .first();
    this.geofenceParentDropdown = page
      .locator(SELECTORS.geofenceParentDropdown)
      .nth(1);
  ...
  async clickNewGeofence(geofenceName, overlapPriority) {
    ...
    await this.geofenceParentDropdown.waitFor({
      state: "visible",
      timeout: TIMEOUTS.default,
    });
